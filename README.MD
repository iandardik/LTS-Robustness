...
The tool can display all four maximal robust deviations (use --num-print flag) and can display each deviation in a different format (use --print-dot or --print-fsp).
